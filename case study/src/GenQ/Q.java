...
public class Q {
	...
	public boolean Judge(Set<Fault> set1,Set<Fault> set2,Fault f1,Fault f2,Set<String> union){	
		//若存在F1'包含于F1*F2且F1-F1^F2不包含于F1'或者存在F2'包含于F1*F2且F2-F1^F2不包含于F2',则F1*F2非最简
		long startTime = System.currentTimeMillis();

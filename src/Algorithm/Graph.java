...
public class Graph
{
	...
	public Map<Integer,Set<Fault>> map = new HashMap<Integer,Set<Fault>>();
	public Set<Integer> validindex = new HashSet<>();
	public int N;
    ...
    public void UpdateFaultInfo(Set<Fault> FS){				//����
    	for(Fault f : FS){
